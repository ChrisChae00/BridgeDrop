(() => {
      ...
      157: (t, e, n) => {
        ...
        function m(t, e, n, o) {
          ...
          const E = (function (t, e, n) {
              ...
              return (function (t, e, n) {
                ...
                let A,
                  ...
                  B = 0;
                for (A = 0; A < E; A++)
                  for (v = 0; v < s; v++) A < w[v].length && (C[B++] = w[v][A]);
                for (A = 0; A < d; A++)
                  for (v = 0; v < s; v++) C[B++] = m[v][A];
                return C;
              })(o, t, e);
            })(e, n, d),
            y = r.getSymbolSize(e),
          ...
          return (
            ...
            isNaN(o) && (o = c.getBestMask(C, w.bind(null, C, n))),
            c.applyMask(o, C),
            w(C, n, o),
            {
              modules: C,
              ...
              i = (function (t, e) {
                ...
                for (let s = 0; s < t.length; s++) {
                  ...
                  for (let t = 0; t < a.length; t++) {
                    const c = a[t],
                      l = "" + s + t;
                    u.push(l), (n[l] = { node: c, lastCount: 0 }), (o[l] = {});
  ...
  (() => {
    "use strict";
    var t = n(583);
    const e = new WebSocket("ws://localhost:8080");
    let r = null;
    (e.onmessage = async (e) => {
        ...
        ? ((r = n.peerId),
          await (async function () {
            const e = document.getElementById("qrCodeCanvas"),
              n = JSON.stringify({ peerId: r });
            await t.toCanvas(e, n),
              console.log("QR Code generated successfully");
          })())
        : "devices" === n.type &&
          (function (t) {
            const e = document.getElementById("deviceList");
            (e.innerHTML = ""),
              t.forEach((t) => {
                const n = document.createElement("li");
                (n.textContent = `Device: ${t.peerId}`),
                  e.appendChild(n),
                  n.addEventListener("click", () => {
                    return (
                      (e = t.peerId), void console.log("Connecting to peer:", e)
                    );
                    var e;
                  });
              });
      ...
      document.getElementById("fileInput").addEventListener("change", (t) => {
        const e = t.target.files[0];
        e &&
          (function (t) {
            console.log("Sending file:", t.name);
          })(e);
      });
  })();
})();
